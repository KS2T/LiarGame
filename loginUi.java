...
class LoginDialog extends JDialog implements ActionListener, KeyListener { //    버튼 클릭시 생성되는 창          todo
    ...
    void init() {
        ImageIcon ii1 = new ImageIcon("Liar1.jpg");
        ImageIcon ii2 = new ImageIcon("Liar2.jpg");
        ImageIcon ii3 = new ImageIcon("Liar3.jpg");

        idLb = new JLabel("", ii1, SwingConstants.CENTER);
        //idLb.setHorizontalAlignment(JLabel.CENTER);
        idTf = new JTextField(10);
        ipLb = new JLabel("", ii2, SwingConstants.CENTER);
        //ipLb.setHorizontalAlignment(JLabel.CENTER);
        ipTf = new JTextField(10);
        portLb = new JLabel("", ii3, SwingConstants.CENTER);
    ...
    Action enter = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            } else (e.getSource().equals(idTf)) {

            }else if (e.getSource().equals(portTf)) {
